        ...
        <div class="card-body p-0">
            ...
            @php
                ...
                $ap8 = [
                    ...
                    'CC' => 'CC – Carta de cupo',
                    'CF' => 'CF – Registro ante la Secretaría de Economía (sector financiero)',
                    'CI' => 'CI – Certificación en materia de IVA e IEPS',
                    'CO' => 'CO – Condonación de créditos fiscales',
                    'CR' => 'CR – Contribuyente con RFC no inscrito en el CFDI',
                    'CS' => 'CS – Copia simple',
                    'DA' => 'DA – Despacho anticipado',
                    'DD' => 'DD – Despacho a domicilio a la importación',
                    'DE' => 'DE – Desperdicios',
                    'DI' => 'DI – Documento de incrementable (CFDI)',
                    'DN' => 'DN – Donación por parte de las empresas',
                    'ED' => 'ED – Estándar de eficiencia energética (NOM)',
                    'EI' => 'EI – Autorización de depósito fiscal',
                    'EM' => 'EM – Empresa de mensajería y paquetería',
                    'EP' => 'EP – Declaración de CURP',
                    'FI' => 'FI – Factor de actualización con índice',
                    'FR' => 'FR – Fecha que rige',
                    'FT' => 'FT – Folio de trámite generado por la ventanilla',
                    'FV' => 'FV – Factor de actualización con valor',
                    'F8' => 'F8 – Depósito fiscal para exposición y venta',
                    'GS' => 'GS – Exportación temporal y retorno de mercancías del sector servicios',
                    'G9' => 'G9 – Transferencia de mercancías que no cambian de propietario',
                    'HC' => 'HC – Operaciones del sector de hidrocarburos',
                    'ID' => 'ID – Importación definitiva de vehículos usados',
                    'IF' => 'IF – Registro ante la Secretaría de Economía (industria farmacéutica)',
                    'IM' => 'IM – Empresas con programa IMMEX',
                    'IR' => 'IR – Recinto fiscalizado estratégico',
                    'J4' => 'J4 – Retorno de mercancía de recinto fiscalizado estratégico',
                    'LD' => 'LD – Despacho por lugar distinto',
                    'LR' => 'LR – Importación por pequeños contribuyentes',
                    'MI' => 'MI – Importación definitiva de muestras',
                    'MJ' => 'MJ – Operaciones de empresas de mensajería y paquetería',
                    'MS' => 'MS – Modalidad de servicios de outsourcing',
                    'MT' => 'MT – Monto total del valor en dólares',
                    'M7' => 'M7 – Opinión favorable de la SE',
                    'NR' => 'NR – Operación en la que las mercancías no fueron presentadas',
                    'OC' => 'OC – Operación tramitada en fase de consolidación',
                    ...
                    'PZ' => 'PZ – Ampliación del plazo para el retorno',
                    'RC' => 'RC – Consecutivo de CFDI / documentos de valor',
                    'RD' => 'RD – Retorno a depósito fiscal de la mercancía',
                    'RL' => 'RL – Responsable solidario',
                    'RO' => 'RO – Revisión en origen por parte de la autoridad',
                    'RQ' => 'RQ – Importación definitiva de remolques, semirremolques y portacontenedores',
                    'RT' => 'RT – Reexpedición por terceros',
                    'RV' => 'RV – Regularización de vehículos',
                    'SF' => 'SF – Clave de unidad autorizada del SAT',
                    'SH' => 'SH – Autorización del SAT',
                    'SO' => 'SO – Socio Comercial Certificado',
                    'ST' => 'ST – Operaciones sujetas al artículo 2.5 del T-MEC',
                    'SU' => 'SU – Operaciones sujetas a los artículos 14 y 15 del T-MEC',
                    'TB' => 'TB – Tránsito de carga consolidada',
                    'TR' => 'TR – Transbordo',
                    'UM' => 'UM – Unidad de medida',
                    'UP' => 'UP – Unidad de producción',
                    'V1' => 'V1 – Transferencia de mercancía (importación temporal virtual)',
                    'VT' => 'VT – Valor de transacción',
                    'XL' => 'XL – Exportación libre (sin restricciones)',
                    'ZC' => 'ZC – Zona de comercio exterior',
                ];
            @endphp
            ...
            @php
                ...
                $ap8p = ['AL'=>'AL – ALADI','AR'=>'AR – Consulta arancelaria','B2'=>'B2 – Art. 2 IEPS','CD'=>'CD – Certificado dispensa temporal','CR'=>'CR – RFC no inscrito en CFDI','DA'=>'DA – Despacho anticipado','DE'=>'DE – Desperdicios','DI'=>'DI – Doc. incrementable CFDI','ED'=>'ED – Estándar eficiencia energética (NOM)','EN'=>'EN – Norma Oficial Mexicana','ES'=>'ES – Estándar de seguridad','EX'=>'EX – Exención de arancel','GS'=>'GS – Exportación temporal y retorno','ID'=>'ID – Importación definitiva vehículos usados','IM'=>'IM – Empresas IMMEX','MI'=>'MI – Importación definitiva muestras','NT'=>'NT – Norma técnica','OM'=>'OM – Operaciones de maquila','PA'=>'PA – Precio arancelario estimado','PC'=>'PC – Pedimento consolidado','PI'=>'PI – Inspección previa','PP'=>'PP – Prog. promoción sectorial','RA'=>'RA – Régimen aduanero especial','RC'=>'RC – Consecutivo CFDI','RF'=>'RF – Rectificación de fracciones','RL'=>'RL – Responsable solidario','SC'=>'SC – Subdivisión de CFDI','SO'=>'SO – Socio Comercial Certificado','ST'=>'ST – Art. 2.5 T-MEC','SU'=>'SU – Arts. 14 y 15 T-MEC','TA'=>'TA – Tasa aplicable por acuerdo','TC'=>'TC – Tipo de cambio especial','TI'=>'TI – Transferencia IMMEX','TL'=>'TL – Trato libre','TR'=>'TR – Transbordo','UM'=>'UM – Unidad de medida','VC'=>'VC – Valor en aduana','VF'=>'VF – Valor de factura','VT'=>'VT – Valor de transacción','VU'=>'VU – Valor usado'];
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const AP8keys = ['AC','AE','AF','AG','AI','AP','AT','AV','A3','BB','BR','CC','CF','CI',
        'CO','CR','CS','DA','DD','DE','DI','DN','ED','EI','EM','EP','FI','FR','FT','FV','F8',
        'GS','G9','HC','ID','IF','IM','IR','J4','LD','LR','MI','MJ','MS','MT','M7','NR','OC',
        'OE','PC','PD','PH','PI','PL','PP','PZ','RC','RD','RL','RO','RQ','RT','RV','SF','SH',
        'SO','ST','SU','TB','TR','UM','UP','V1','VT','XL','ZC'];
    ...
    function buildIdentClaveSelect(name) {
        ...
        AP8keys.forEach(v => sel.append(new Option(v, v)));
        return sel;
    }
    ...
    const AP8P_keys  = {'AL':'ALADI','AR':'Consulta arancelaria','B2':'Art. 2 IEPS','CR':'RFC no inscrito','DA':'Despacho anticipado','DE':'Desperdicios','DI':'Doc. incrementable','ED':'Estándar eficiencia NOM','EN':'Norma Oficial Mexicana','ES':'Estándar seguridad','EX':'Exención arancel','IM':'IMMEX','MI':'Muestras','NT':'Norma técnica','OM':'Maquila','PA':'Precio estimado','PC':'Pedimento consolidado','PI':'Inspección previa','PP':'Prom. sectorial','RA':'Régimen especial','RC':'Consecutivo CFDI','RF':'Rectificación fracciones','RL':'Responsable solidario','SC':'Subdivisión CFDI','SO':'Socio Cert.','ST':'Art. 2.5 T-MEC','SU':'Arts. 14-15 T-MEC','TA':'Tasa por acuerdo','TC':'Tipo cambio esp.','TI':'Transf. IMMEX','TL':'Trato libre','TR':'Transbordo','UM':'Unidad de medida','VC':'Valor aduana','VF':'Valor factura','VT':'Valor transacción','VU':'Valor usado'};
    ...
    function getPartidaTemplate(idx) {
        ...
        const ap8pl = {'AL':'ALADI','AR':'Consulta arancelaria','B2':'Art.2 IEPS','CR':'RFC no inscrito CFDI','DA':'Despacho anticipado','DE':'Desperdicios','DI':'Doc. incrementable CFDI','ED':'Estandar eficiencia NOM','EN':'Norma Oficial Mexicana','ES':'Estandar seguridad','EX':'Exencion arancel','IM':'IMMEX','MI':'Muestras','NT':'Norma tecnica','OM':'Maquila','PA':'Precio estimado','PC':'Pedimento consolidado','PI':'Inspeccion previa','PP':'Prom. sectorial','RA':'Regimen especial','RC':'Consecutivo CFDI','RF':'Rectificacion fracciones','RL':'Responsable solidario','SC':'Subdivision CFDI','SO':'Socio Certificado','ST':'Art.2.5 T-MEC','SU':'Arts.14-15 T-MEC','TA':'Tasa por acuerdo','TC':'Tipo cambio especial','TI':'Transferencia IMMEX','TL':'Trato libre','TR':'Transbordo','UM':'Unidad de medida','VC':'Valor aduana','VF':'Valor factura','VT':'Valor transaccion','VU':'Valor usado'};
