...
<div class="row g-3 mb-4">
    @foreach([
        ...
        ['label'=>'Enviados',        'value'=>$stats['transmitido'],'icon'=>'bi-send',             'color'=>'#2b6cb0'],
        ['label'=>'Liberados',       'value'=>$stats['liberado'],   'icon'=>'bi-check-circle',     'color'=>'#276749'],
    ] as $k)
...
{{-- Solo 2 cards centradas --}}
<div class="d-flex justify-content-center gap-4 mb-4">
    <a href="{{ route('pedimentos.index') }}" class="card-option" style="width:260px">
        <i class="bi bi-file-earmark-text"></i>
        Gestión de Pedimentos
    </a>
    <a href="{{ route('usuarios.index') }}" class="card-option" style="width:260px">
